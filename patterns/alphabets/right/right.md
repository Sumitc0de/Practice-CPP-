...
Print a right aligned alphabet triangle where every row starts from A and increases up to the row length.
...
Leading spaces shift the row to the right, then j controls the alphabet character printed.
