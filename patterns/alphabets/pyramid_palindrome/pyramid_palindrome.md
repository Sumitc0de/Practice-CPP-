...
Print a centered alphabet pyramid where each row increases from A to the row character and then decreases back to A.
...
The pattern is split into spaces, an increasing alphabet half, and a decreasing alphabet half.
...
- Main concepts: Nested Loops, ASCII, Palindrome.
...
- `Spaces = n - i`
- `Increasing characters = A through A + i - 1`
- `Decreasing characters = A + i - 2 down to A`
