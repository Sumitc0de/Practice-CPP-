...
Print a full diamond by combining a full pyramid and an inverted full pyramid without repeating the middle row.
...
The first loop builds the upper half. The second loop starts at i = 2, increasing spaces and decreasing stars.
...
- Main concepts: Nested Loops, Spaces, Symmetry.
