...
Print an n by n solid square of stars.
...
Both loops run n times, so every cell in the square prints one star.
...
- Main concepts: Nested Loops, Square Pattern, Star Pattern.
