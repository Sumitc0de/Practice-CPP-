...
Print an indented inverted half pyramid. Each row starts with spaces and then prints a decreasing number of stars.
...
The first inner loop prints i spaces. The second loop prints n - i + 1 stars.
...
- Main concepts: Nested Loops, Spaces, Inverted Triangle.
