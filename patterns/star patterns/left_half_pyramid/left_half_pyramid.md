...
Print an indented half pyramid where leading spaces decrease and stars increase. Because the star loop is j < i, the first row prints only spaces and no star.
...
The code prints n - i spaces and i - 1 stars. This creates a shifted pyramid with a blank first row.
...
- Main concepts: Nested Loops, Spaces, Triangle.
