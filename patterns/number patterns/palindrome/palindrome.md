...
Print a centered number pyramid where each row increases from 1 to i and then decreases back to 1.
...
The pattern uses leading spaces, an increasing numeric half, and a decreasing numeric half.
...
- `Spaces = n - i`
- `Increasing numbers = 1 through i`
- `Decreasing numbers = i - 1 down to 1`
