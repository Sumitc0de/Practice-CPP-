...
Print an inverted number triangle where every row starts from 1 and ends at n - i + 1.
...
The loop limit n - i + 1 reduces the number of columns by one after every row.
...
- Main concepts: Nested Loops, Inverted Triangle, Increasing Sequence.
